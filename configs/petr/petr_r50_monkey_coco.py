...
model = dict(
    ...
    bbox_head=dict(
        ...
        transformer=dict(
            ...
            encoder=dict(
                type='mmcv.DetrTransformerEncoder', # this is visual feature encoder
                num_layers=6,
            ...
            decoder=dict(
                type='opera.PetrTransformerDecoder', # pose decoder
                num_layers=3,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='opera.MultiScaleDeformablePoseAttention', #joint decoder
                            embed_dims=256)
                    ],
                    feedforward_channels=1024,
                    ffn_dropout=0.1,
