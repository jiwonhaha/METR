...
class NHPDataset(CocoDataset):


    """
    OpenMonkey keypoint indexes::
        0: 'right_eye',
        1: 'left_eye',
        2: 'nose',
        3: 'head',
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(NHPDataset, self).__init__(*args, **kwargs)
    ...
    def evaluate(self,
        ...
        for metric in metrics:
            ...
            try:
                ...
                with open('epoch_114_data.json', 'w') as file:
            ...
            if metric == 'proposal':
                ...
                # cocoEval.params.iouThrs = [0.9]  #To get AP @ particular result
                cocoEval.evaluate()
                cocoEval.accumulate()
...
#                 print('AP at IoU=0.7:', cocoEval.stats[0])
