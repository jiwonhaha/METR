...
class PETR(DETR):
    ...
    def imshow_det_bboxes(self,
        ...
        if num_keypoint == 14:
            ...
            ec = [(221, 160, 221), (221, 160, 221), (255, 0, 0),(0, 0, 128),
                  (70, 130, 180),
                  (30, 144, 255), (100, 149, 237), (173, 216, 230), (135, 206, 250),
                  (255, 165, 0), (127, 255, 0), (128, 128, 0), (46, 139, 87),
                  (0, 128, 0), (255, 255, 0)]
        else:
            raise ValueError(f'unsupported keypoint amount {num_keypoint}')
